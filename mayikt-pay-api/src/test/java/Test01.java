...
public class Test01 {
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/mayikt_test12?useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT%2B8",
                                 "root", "123456")
...
//                    .enableSwagger() // 开启 swagger 模式
            ...
            .packageConfig(builder -> {
                builder.parent("com.mayikt.pay") // 设置父包名
