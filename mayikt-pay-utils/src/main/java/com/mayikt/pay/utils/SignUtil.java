...
public class SignUtil {
     ...
     * 加盐key
     */
    public final static String SALT_KEY = "mysecret123456";
    ...
    public static boolean verifyJson(String sign, String timestamp,
                                     String json, String saltKey) {
        String mysign =
                DigestUtils.md5Hex(getContentBytes(json + "," + timestamp + (StringUtils.isEmpty(saltKey) ? SALT_KEY : saltKey), INPUT_CHARSET));
